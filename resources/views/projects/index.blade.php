        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                <div class="mb-4">
                    ...
                    <input type="text" id="title" class="border border-muted-light p-2 text-xs block w-full">
                </div>

                <div class="mb-4">
                    <label for="description" class="text-sm block mb-2">Description</label>
                    <textarea id="description" class="border border-muted-light p-2 text-xs block w-full" rows="7"></textarea>
                </div>
            </div>
            ...
            <div class="flex-1 ml-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="border border-muted-light p-2 text-xs block w-full" placeholder="Task 1">
                </div>
